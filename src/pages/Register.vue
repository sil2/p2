<template>
  <div class="flex-grow border border-solid rounded-md drop-shadow-lg bg-white  border-white text-black p-2 m-2">
        ...
        <form @submit="handleRegister" :validation-schema="schema" class="mt-8 space-y-6" action="#" method="POST">
          ...
          <div class="-space-y-px rounded-md shadow-sm">
            ...
            <input id="username" name="email" type="text" required=""
              class="relative block w-full appearance-none r rounded border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-red-500 focus:outline-none focus:ring-red-500 sm:text-sm"
              :placeholder="$t('name')" />
